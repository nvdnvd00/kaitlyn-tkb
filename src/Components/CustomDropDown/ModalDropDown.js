...
export default class ModalDropdown extends Component {
	...
	_calcPosition() {
		...
		const height =
			StyleSheet.flatten(dropdownStyle)?.height > StyleSheet.flatten(dropdownStyle)?.maxHeight
				? StyleSheet.flatten(dropdownStyle)?.maxHeight
				: StyleSheet.flatten(dropdownStyle)?.height;
		const dropdownHeight =
			(dropdownStyle && height) || StyleSheet.flatten(styles.dropdown).height;
